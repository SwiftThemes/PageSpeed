...
add_action( 'customize_register', 'nybr_customize_archives', 600 );
function nybr_customize_archives( $wp_customize ) {


	$wp_customize->add_panel( 'archives', array(
		'title'       => __( 'Archives (Categories,Tags etc&hellip;)', 'nybr' ),
...
&lt;hr class="separator"&gt;
	...
	$wp_customize->add_control( 'archives_show_thumbnails', array(
		'label'   => __( 'Show thumbnails on archives', 'nybr' ),
		'section' => 'archives_design',
		'type'    => 'checkbox',
	...
	$wp_customize->add_control(
		new Helium_Customize_Control_Image_Size(
			...
			'archives_thumb',
			array(
				'label'    => esc_html__( 'Archives thumbnail size', 'nybr' ),
				'section'  => 'archives_design',
				'priority' => 10,
				'type'     => 'text',
				'settings' => array(
