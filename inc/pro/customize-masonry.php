...
function pagespeed_customize_masonry( $wp_customize ) {
	...
	//layout_settings
	$wp_customize->add_setting( 'use_masonry', array(
		'sanitize_callback' => 'helium_boolean',
		'default'           => false,
//		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'use_masonry', array(
	...
	$wp_customize->add_setting( 'masonry_column_count', array(
...
//		'transport'         => 'postMessage',
	...
	$wp_customize->add_control( 'masonry_column_count', array(
		...
		'active_callback' => function () {
		return get_theme_mod( 'use_masonry', false );
	}
	) );
