...
function pagespeed_customize_misc( $wp_customize ) {
	...
	$wp_customize->add_setting( 'show_first_post_in_full', array(
		'sanitize_callback' => 'helium_boolean',
		'default'           => false,
	) );

	$wp_customize->add_control( 'show_first_post_in_full', array(
		...
		'active_callback' => function () {
			return get_theme_mod( 'home_show_excerpts', true );
		},
	) );
}