...
function pagespeed_customize_header_pro( $wp_customize ) {
	...
	$wp_customize->add_setting( 'show_contact_info_ah', array(
		'sanitize_callback' => 'helium_boolean',
		'default'           => false,
	) );

	$wp_customize->add_control( 'show_contact_info_ah', array(
	...
	$wp_customize->add_setting( 'show_social_media_ah', array(
		'sanitize_callback' => 'helium_boolean',
		'default'           => false,
	) );

	$wp_customize->add_control( 'show_social_media_ah', array(
