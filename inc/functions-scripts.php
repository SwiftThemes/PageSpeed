...
function pagespeed_register_scripts() {
	//@todo remove
	wp_register_script( 'pagespeed-vendors-js', THEME_JS_URI . 'vendors.min.js', array( 'jquery' ) );
	wp_register_script( 'pagespeed-custom-js', THEME_JS_URI . 'custom.min.js', array( 'jquery' ) );
	wp_register_script( 'pagespeed-custom-js-dev', THEME_JS_URI . 'custom/desktop.js', array( 'jquery' ) );
}
