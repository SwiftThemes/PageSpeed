...
function helium_theme_menu() {
	...
	$helium_theme_options = add_theme_page(
		__('PageSpeed Theme Helpers','page-speed'),            // The title to be displayed in the browser window for this page.
		__('PageSpeed Helpers'),            // The text to be displayed for this menu item
