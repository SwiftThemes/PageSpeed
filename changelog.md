...
- Fix an issue with license nag.

## [2.17] - 15-02-2019

### Changed

- Fix image imporoper scaling issues.

## [2.16] - 11-02-2019

### Added

- Option to customize the archives title.
- Option to set slider speed.
- Add download icon.
- You can now add icons to buttons by adding the classes `he-icon` and `he-download`
